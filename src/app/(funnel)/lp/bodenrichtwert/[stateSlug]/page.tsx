...
export async function generateMetadata(
	...
	const title = `Bodenrichtwert ${data.cityName} 2026 | Jetzt kostenlos abfragen`;
	const description = `Aktuelle Bodenrichtwerte 2026 für ${data.cityName}. Jetzt kostenlos Grundstückswert für Ihre Adresse abfragen.`;
